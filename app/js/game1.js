...
function operationButton(data){
    ...
    if(data=='2'){
        html+='<div class="divCoin divCoin1" style="display: block;margin-left:10%;'
        ...
        html+='             </div>'
        html+='             </div> '
        html+='             <div class="divCoin divCoin2" style="display: block;margin-left:10%;'
        ...
        html+='              </div>'
        html+='             </div> '
        html+='             <div class="divCoin divCoin3" style="display: block;margin-left:10%;'
        ...
        html+='              </div>'
        html+='             </div> '
        html+='             <div class="divCoin divCoin4" style="display: block;margin-left:10%;'
