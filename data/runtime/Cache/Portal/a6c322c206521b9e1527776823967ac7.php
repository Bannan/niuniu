...
$(function() {  
  ...
  var shareimg = 'http://'+window.location.hostname+'/app/img-cl.jpg';//分享的图片
...
<?php if(count($room['userlist']) >= 6 && $room['userlist'][$user['id']] != 1): ?><div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="/app/img/sangong/note4.png" class="return" style="right: 60px;" onclick="opnemm('fangjian_tishi','tishi')" /> 
  ...
  <div id="divRobBankerText" class='sangong-Text'></div> 
    ...
    <div id="operationButton" style="top: 52%;"></div> 
  </div> 
