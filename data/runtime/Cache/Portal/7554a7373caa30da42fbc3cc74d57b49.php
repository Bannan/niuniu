...
<title><?php echo ($room["roomid"]); ?>号十人牛牛房间</title>

<link rel="stylesheet" type="text/css" href="/app/style-cl/css/bull_vue-2.0.3.css">
...
<link rel="stylesheet" type="text/css" href="/app/style-cl/css/base-cl.css"> 
<style>
  .mainPart{
    position: relative;
    height: auto;
...
$(function() {  
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号十人牛牛房间';//分享的标题
  var shareimg = 'http://'+window.location.hostname+'/app/cl-img.jpg';//分享的图片
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="/app/style-cl/img/niuniu-top-bg1.png" alt="" class="tabBottom" /> 
   <div class="round jiurenniuniu-round" style="" id="jsxx">
    <?php echo ($room["js"]); ?>&nbsp;/&nbsp;<?php echo ($room["zjs"]); ?>局
   </div> 

   <img src="/app/img/bull9/btn_game_home.png" class="return jiurenniuniu-return-index"  onclick="opnemm('fangjian_fanhuisy','tishi')" /> 
...
">
   ...
   <div class="bottomHistory jiurenniuniu-bottomHistory" onclick="opnemm('fangjian_yinyue','vaudioRoom')">
    <img class='jiurenniuniu-bottomHistory-img' src="/app/style-cl/img/game-music01.png"/>
   </div> 
...
"></div> 
   ...
   <div id="table" class="table">
    <?php switch ($room['skin']) { case 'feiying': $pall_img = 'fy'; break; case 'dasheng': $pall_img = 'ds'; break; case 'lianyun': $pall_img = 'ly'; break; default: $pall_img = 'fy'; }?>
    <img src="/app/style-cl/img/background-<?php echo $pall_img;?>.jpg" class="tableBack" /> 
 ...
 <div class="myCards" style="display: none;"></div>
    ...
    <div class="member-list-vacancy">
      <div class="vacancy vacancy-1">空位</div>
      <div class="vacancy vacancy-2">空位</div>
      <div class="vacancy vacancy-3">空位</div>
      <div class="vacancy vacancy-4">空位</div>
      <div class="vacancy vacancy-5">空位</div>
      <div class="vacancy vacancy-6">空位</div>
      <div class="vacancy vacancy-7">空位</div>
      <div class="vacancy vacancy-8">空位</div>
      <div class="vacancy vacancy-9">空位</div>
      <div class="vacancy vacancy-10">空位</div>
    </div>
    <div id="member"></div> 
...
<?php if(count($room['userlist']) >= 10 && $room['userlist'][$user['id']] != 1): ?><div id="valert2" class="alert">
...
<?php if((count($room['userlist']) > 0 && $room['js'] == 0) || ($room['js'] > 0 && !$room['userlist'][$user['id']])): ?><div id="valert" class="alert">
   ...
   <div class="mainPart" style="margin-top: -34vh;">
    ...
    <div class="id">
     ...
     <div class="text">
       你的<?php echo ($titlexx); ?>ID:<?php echo ($user["id"]); ?> 
     </div>
    </div>
